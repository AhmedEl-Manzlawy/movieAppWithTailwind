  ...
  if (movie === "Loading")
    ...
    return (
      <div className="bg-[#000] min-h-screen py-5 flex flex-col justify-center items-center font-iti ">
        <div className="flex flex-col p-4 mt-4 border border-black sm:flex-col md:text-black xs:text-black rounded-lg font-iti md:flex-row md:space-x-8 md:mt-0 md:text-xl md:font-bold">
          <NavLink
            to="/"
