...
async function getMovie(pageNo) {
  const res = await axios.get(
    `https://api.themoviedb.org/3/discover/movie?with_genres=18&sort_by=vote_average.desc&vote_count.gte=10&api_key=d751f12db3431eb3928b112310ae9364&api_key=d751f12db3431eb3928b112310ae9364&page=${pageNo}`
  );
